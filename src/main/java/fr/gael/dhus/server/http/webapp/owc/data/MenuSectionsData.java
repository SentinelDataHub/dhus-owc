...
{   
   ...
   public MenuSectionsData (String title, String component, 
		   String icon, String width, String remoteUrl, String maxInstances)
   {
      this.title = title;
   ...
   public boolean equals (Object o)
   {
      return o instanceof MenuSectionsData && ((MenuSectionsData) o).component == this.component
			  ...
			  && ((MenuSectionsData) o).maxInstances == this.maxInstances;
   }

   public MenuSectionsData copy ()
   {
      MenuSectionsData copy = new MenuSectionsData(title, component, icon, width, remoteUrl, maxInstances);      
      return copy;
   }
