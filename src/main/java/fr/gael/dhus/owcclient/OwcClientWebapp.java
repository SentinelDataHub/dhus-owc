...
@Component
@WebApp(name = "new",welcomeFiles="new")
public class OwcClientWebapp extends WebApplication
{
   private static Log logger = LogFactory.getLog (OwcClientWebapp.class);
 ...
 @Override
   ...
   {
      return OwcClientWebapp.class.getClassLoader ().getResourceAsStream (
         "owc-client.war");
